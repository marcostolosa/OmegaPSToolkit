#---[Metadata]------------------------------------------------------#
#  Filename ~ OmegaDSToolkit[v0.0.0.6#dev]    [Update: 09-02s-2022]  #
#---[Info]----------------------------------------------------------#
...
def informationgathering_scan_mainpage():
    ...
    sys.stdout.write("\x1b]2;OmegaDSToolkit | ODST/Information Gathering/ScanTools\x07")               #
    cls()
...
def windowstools_networkC_main_page():
    ...
    print(bC+"       ╚══════╗   ")
    print(bC+"              ╟────"+r+r+gC+"► "+r+"["+bC+"1"+r+"]"+gC+"     Ping"+r)
    print(bC+"              ╟────"+r+r+gC+"► "+r+"["+bC+"2"+r+"]"+gC+"     Network commands (ping, telnet etc)"+r)
    print(bC+"              ╟────"+r+r+gC+"► "+r+"["+bC+"x"+r+"]"+gC+"     Return to the main page\n"+r)
...
def main_page():
    ...
    print(bC+"        MMMMMMMMMMMdy+:.```..```.-/shNMMMMMMMMMM "+r+gC+"      |_____|_|_|_|___|_  |__,|____/|_____| |_| |___|___|_|_,_|_|_| "+r)                                #
    print(bC+"        MMMMMMMNy/``  -ohmNNNNNdy/`  `:smMMMMMMM "+r+gC+"                      |___|"+rC+gC+"                                          v"+rC+f"{version}"+r)                #
    ...
    print(bC+"        MMN`     yMMMMMMMMMMMMMMMMMMMMN`     sMM "+r+bC+"      ╟──────"+gC+"►"+bC2+" Version          : v"+rC+f"{version}"  +r)
